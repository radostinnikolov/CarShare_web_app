...
import carshare_v2.accounts.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', carshare_v2.accounts.managers.AppUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='images/Default-welcomer.png', null=True, upload_to='images')),
