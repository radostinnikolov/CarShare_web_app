...
class TransportSerializer(serializers.ModelSerializer):
    ...
    driver_name = serializers.CharField(source='driver.profile.first_name', read_only=True)
    passengers_count = serializers.CharField(source='passengers.count', read_only=True)

    class Meta:
        model = Transport
        fields = ['id', 'from_city_name', 'to_city_name', 'driver_id', 'driver_name', 'description', 'date', 'time', 'total_seats',
